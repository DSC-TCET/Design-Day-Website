    ...
    <section>
      <div className="mt-20" id="about">
        ...
        <div className="mx-16 mb-10 text-xl tracking-wider">
          ...
          solutions.<br></br><br></br>  The event provides an opportunity for participants to
          refine their ideas, receive feedback from experts, and learn more
          about Google's technologies and design principles.<br></br><br></br> Design Day
          ...
          products or services.<br></br><br></br> At the end of Design Day, participants present
